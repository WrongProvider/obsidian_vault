...
![Diagram of route from public to private.](../_resources/6-public-private-route-1.svg)ssh -t -o StrictHostKeyChecking=no azureuser@$PUBLICIP 'traceroute private --type=icmp; exit'

![Diagram of route from public to private.](../_resources/6-public-private-route-2.svg)ssh -t -o StrictHostKeyChecking=no azureuser@$PRIVATEIP 'traceroute public --type=icmp; exit'

![Diagram of route from public to private.](../_resources/6-public-private-route.svg)