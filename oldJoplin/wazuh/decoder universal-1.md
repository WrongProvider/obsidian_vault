...
<!--  <regex>et="(GNRL_EV_\w+)"</regex> -->
  <regex>et="(GNRL_\w+)"|et="(KLSRV_\w+)"|et="(000\d+)"</regex>
  <order>ksc_event_id</order>
</decoder>

<decoder name="kaspersky-ksc">
  <parent>kaspersky-ksc</parent>
  <regex>etdn="(\.+)"</regex>
  <order>event_alert</order>
</decoder>
